...
import { sendPasswordResetMail, sendVerificationEmail, sendWelcomeEmail } from "../mailtrap/emails.js";
...
export const signup = async(req, res) =>{
    ...
    try {
        ...
        await sendVerificationEmail(recipientEmails, verificationToken)
...
export const verifyEmail = async(req, res) =>{
    ...
    try {
        ...
        try {
            ...
            return res.status(500).json({ success: false, message: "User verified, but failed to send welcome email." });
        }
        res.status(200).json({
            success:true,
